...
| 17 | Kept looking for a simple local set of rules to run the simulation and sort of found it in the end. Ugly code but I'm happy with the algorithm I ended up with. First working version took 10 minutes to finish but I was able to optimize it alot down to 0.1 seconds :D | https://github.com/filipux/adventofcode2018/blob/master/a17.nim  |
